...
const PATHS: Record<string, string> = {
  ...
  "sidebar-toggle": "M3 5h18v14H3zM9 5v14",
  ...
  "thumbs-up":      "M14 9V5a3 3 0 0 0-6 0v4H3v12h14a3 3 0 0 0 3-3v-7a3 3 0 0 0-3-3h-3z",
  "thumbs-down":    "M10 15v4a3 3 0 0 0 6 0v-4h5V3H7a3 3 0 0 0-3 3v7a3 3 0 0 0 3 3h3z",
  more:             "M12 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM19 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2zM5 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2z",
  x:                "M18 6L6 18M6 6l12 12",
  check:            "M20 6L9 17l-5-5",
  sparkles:         "M12 3l1.9 5.1L19 10l-5.1 1.9L12 17l-1.9-5.1L5 10l5.1-1.9L12 3zM18 15l1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2zM5 17l.7 1.4L7 19l-1.3.6L5 21l-.7-1.4L3 19l1.3-.6L5 17z",
  key:              "M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3M15.5 7.5L19 4",
  share:            "M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8M16 6l-4-4-4 4M12 2v13",
  star:             "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z",
  pin:              "M12 17v5M9 10.76V4h6v6.76l1.59 2.45a1 1 0 0 1-.84 1.54H8.25a1 1 0 0 1-.84-1.54L9 10.76z",
